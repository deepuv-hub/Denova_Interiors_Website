              ...
              >
                <img
                  ...
                  className={`w-full h-full object-cover transition-transform ease-out ${
                    currentSlide === idx ? 'scale-105 opacity-40' : 'scale-100 opacity-0'
                  }`}
                  style={{ transitionDuration: '6500ms' }}
                  loading={idx === 0 ? "eager" : "lazy"}
                />
                {/* Elegant dark emerald gradient tint */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A2526] via-[#0A2526]/75 to-transparent"></div>
              </div>
            ))}
          </div>
